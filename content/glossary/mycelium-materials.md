...
term_type: "material"
related: ["Bio-based", "Compostable", "Packaging"]
summary: "Mycelium-based materials are bio-composites grown from fungal mycelium on agricultural waste substrates. They serve as biodegradable alternatives to synthetic foams (EPS, polyurethane) in packaging, insulation, and construction applications."
major_producers: ["Ecovative Design", "Mogu", "Grown.bio", "BioFab"]
applications: ["Protective packaging", "Insulation panels", "Furniture cores", "Fashion and leather alternatives", "Construction materials"]
standards: ["EN 13432 (packaging)", "Home compostability certifications"]
sitemap:
  priority: 0.6
---
...
1. **Substrate preparation**: Agricultural waste is cleaned and sterilized
2. **Inoculation**: Mycelium spawn is added to the substrate
3. **Growth**: Mycelium colonizes the substrate over 5-7 days in controlled conditions (temperature, humidity, CO2)
4. **Molding**: The growing material is shaped into the desired product form
5. **Heat treatment**: Stabilizes the material and stops further growth
