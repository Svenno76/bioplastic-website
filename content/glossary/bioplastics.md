...
| Material | Origin | Biodegradable? | Main Applications |
|----------|--------|---------------|-------------------|
| PLA | Plant starch (corn, sugarcane) | Yes (industrial compost) | Packaging, food service, 3D printing, textiles |
| PHA | Bacterial fermentation | Yes (soil, marine, compost) | Packaging, medical, agriculture, marine |
| PBAT | Fossil-based (but biodegradable) | Yes (industrial compost) | Films, bags, compostable packaging |
| Bio-PE | Sugarcane ethanol | No (recyclable) | Bottles, containers, film |
| Bio-PET | Partially plant-based | No (recyclable) | Bottles (PlantBottle-type) |
| Starch blends | Various starches + PBAT/PLA | Yes (industrial compost) | Bags, loose fill, food service |
| PEF | Plant-based fructose | No (recyclable) | Bottles, films (PET alternative) |
...
No. Bio-PE and bio-PET are chemically identical to their petroleum-based counterparts and are recyclable but not biodegradable. PLA, PHA, PBAT, and starch blends are biodegradable under industrial composting conditions.

**Can bioplastics replace all conventional plastics?**
Not currently. Bioplastics are already competitive in packaging, food service, agriculture, and some medical applications. Technical limitations in thermal resistance, barrier properties, and mechanical performance exclude them from many engineering and infrastructure applications. Ongoing development is steadily expanding the range of viable applications.

**Do bioplastics degrade in landfills?**
Most compostable bioplastics require industrial composting conditions (high heat, humidity, microbial activity) and degrade very slowly in landfills. Bio-PE and bio-PET, being non-biodegradable, can be recycled but otherwise persist identically to conventional PE and PET.

**Are bioplastics better for the environment?**
It depends on the material, the application, and the end-of-life pathway. For packaging destined for composting, bioplastics generally offer significant greenhouse gas reductions and avoid persistent pollution. For durable applications requiring decades of service life, conventional recycled plastics or bio-based non-biodegradable alternatives may be more appropriate.

## Related Terms

Learn more about specific bioplastic materials and related concepts:
- [PLA (Polylactic Acid)](/glossary/pla/)
- [PHA (Polyhydroxyalkanoates)](/glossary/pha/)
- [PBAT](/glossary/pbat/)
- [Starch-based Bioplastic](/glossary/starch-based-bioplastic/)
- [Biodegradable](/glossary/biodegradable/)
- [Compostable](/glossary/compostable/)
- [EN 13432](/glossary/en-13432/)
- [Drop-in Bioplastic](/glossary/drop-in-replacement/)
