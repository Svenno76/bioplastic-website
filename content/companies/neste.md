...
| Capacity | Largest LWP upgrading facility globally |
| Feedstock | Liquefied waste plastic (pyrolysis oil) from chemical recycling |
| Output | High-quality renewable feedstock for steam crackers |
| Status | Commissioned March 2026, gradual ramp-up through 2026 |
| Technology | Proprietary upgrading/hydroprocessing |
...
- Alterra's thermochemical liquefaction technology
- Neste's Porvoo upgrading expertise  
...
| Site | Capacity | Focus |
|------|----------|-------|
| Porvoo, Finland | ~2.6 Mton/year renewable products | LWP upgrading, renewable diesel, SAF, naphtha |
| Rotterdam, Netherlands | ~1.4 Mton/year | Renewable diesel, SAF, renewable naphtha |
| Singapore | ~1.3 Mton/year (expanding to 2.6) | Renewable diesel, SAF |
| Martinez, California | Renewable diesel, SAF | North American market |
...
## Related News
- [Technip Energies, Alterra and Neste Launch Nerea™ — Standardized Modular Solution for Plastic Chemical Recycling](/news/2026-07-03-technip-energies-alterra-neste-launch-nerea-standardized-modular-chemical-recycling/)

## Related Terms
- [Chemical Recycling](/glossary/chemical-recycling/) — Industry category
- [Liquefied Waste Plastic (LWP)](/glossary/liquefied-waste-plastic/) — Feedstock Neste upgrades
- [Pyrolysis Oil](/glossary/pyrolysis-oil/) — Primary LWP form
- [Thermochemical Liquefaction](/glossary/thermochemical-liquefaction/) — Upstream technology
- [Sustainable Aviation Fuel (SAF)](/glossary/sustainable-aviation-fuel/) — Neste's flagship aviation product
- [NEXBTL](/glossary/nexbtl/) — Neste's renewable technology platform
- [Mass Balance](/glossary/mass-balance/) — Certification approach for circular feedstocks
