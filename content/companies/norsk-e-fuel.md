...
headquarters: "Norway"
status: Active
short_description: "Norsk e-Fuel is a Norwegian sustainable chemistry company developing Power-to-Liquid (PtL) technology to convert captured CO₂ and water into synthetic fuels and feedstocks. The company partners with Braskem to produce e-Naphtha for bioplastics applications, enabling the creation of carbon-neutral plastics from captured atmospheric CO₂."
website: "https://www.norsk-e-fuel.com"
founded: "2019"
employees: "Not specified"
primary_materials: "Captured CO₂, water, renewable electricity"
market_segments: "Sustainable aviation fuels, e-fuels, bioplastics feedstocks, circular plastics, carbon-negative materials"
...
**Process Overview:**
- Captures CO₂ directly from the atmosphere (Direct Air Capture - DAC)
- Uses renewable electricity to convert CO₂ and water
- Applies Fischer-Tropsch synthesis for fuel and chemical production
- Creates synthetic hydrocarbons equivalent to crude oil derivatives

**CO₂ Capture Technology:**
- Direct Air Capture (DAC) using Climeworks systems
- Modular CO₂ collectors (stackable for scalability)
- Industrial-scale CO₂ extraction
...
2. Renewable electricity-powered conversion
3. Fischer-Tropsch synthesis to hydrocarbons
4. Separation of fuels and chemical feedstocks
5. Refined products equivalent to fossil fuels

**Output Products:**
- Synthetic fuels (e-fuels)
- e-Naphtha (chemical feedstock)
- e-Crude oil equivalents
- Bioplastics feedstocks
