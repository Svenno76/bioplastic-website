...
status: Active
short_description: "PhaBuilder is a leading Chinese synthetic biology company developing advanced polyhydroxyalkanoate (PHA) biopolymers using proprietary halophilic microorganism engineering. Founded in 2021 by Tsinghua University researchers and led by Professor Guoqiang Chen, PhaBuilder is constructing a 30,000 MT/year Next Generation Industrial Biotechnology (NGIB) facility and operating production plants in Beijing and Yichang, positioning itself as a global leader in engineered PHA manufacturing."
website: "https://eng.phabuilder.com/"
founded: "2021"
employees: "50-150"
primary_materials: "PHA (Polyhydroxyalkanoate) - diverse polymer variants, biodegradable biopolymers, engineered polymer compositions"
market_segments: "Packaging (flexible and rigid), single-use items, disposables, fibers, nonwovens, straws and cutlery, advanced applications"
publicly_listed: false
production_capacity:
  - biopolymer: "PHA (Engineered variants)"
    capacity: "30,000 MT/year target (under construction); pilot and commercial scale operational"
    location: "Beijing China-German Industrial Park; Yichang, Hubei Province"
...
**Research History:**
Professor Chen's PHA research at Tsinghua University spans decades, including pioneering work developing halophilic bacterial platforms for PHA production. This academic foundation established the technological basis for PhaBuilder's commercial venture.
...
**Investment Success:**
PhaBuilder has achieved exceptional investor interest, completing three funding rounds:
...
PhaBuilder's unique technological approach utilizes halophilic bacteria—microorganisms that thrive in salt-rich environments:
...
Halophilic organisms offer significant advantages over conventional fermentation microbes:
...
**Polymer Diversity:**
Through metabolic engineering of Halomonas, PhaBuilder produces diverse PHA compositions:
...
Different PHA compositions enable customization of:
...
**Strategic Application Emphasis:**
PhaBuilder's product development strategy particularly emphasizes single-use items where biodegradability provides maximum environmental value:
...
PhaBuilder's PHA materials demonstrate rapid, complete biodegradation:
...
PhaBuilder's fermentation platform utilizes diverse renewable feedstocks:
...
**Material Lifecycle:**
From renewable feedstock through complete biodegradation, PhaBuilder's PHA materials exemplify circular economy principles:
...
PHA production offers significant carbon footprint advantages vs. conventional plastics:
...
**Climate Impact:**
On a lifecycle basis, PhaBuilder's PHA materials demonstrate substantial reduction in carbon footprint compared to conventional plastics, supporting climate change mitigation objectives.

## Strategic Vision and "4P" Framework

### PHAmily: PHA Polymer Variant Family

**Comprehensive Product Diversity:**
PhaBuilder's strategic vision encompasses creating an extensive family of PHA polymer variants:
...
**Halophilic NGIB Approach:**
PhaBuilder's use of halophilic organisms and NGIB technology provides significant competitive differentiation:
...
PhaBuilder competes among global PHA leaders including Bluepha, Ningbo Tianan, TotalEnergies Corbion, and CJ Biomaterials. Its NGIB platform, academic foundation, and aggressive expansion position it as a top-tier competitor.
...
**Industry Leadership:**
PhaBuilder aspires to transform the global plastic industry through:
...
**Sources:**
- [PhaBuilder Official Website](https://eng.phabuilder.com/)
- [PhaBuilder Company Introduction](https://eng.phabuilder.com/company)
- [PhaBuilder Synthetic Biology Innovation - The Mills Fabrica](https://www.themillsfabrica.com/about-us/insights/blogs/innovation-series-understanding-synthetic-biology-with-phabuilder/)
- [PhaBuilder Member Portrait - European Bioplastics](https://www.european-bioplastics.org/member-portrait-phabuilder/)
- [PhaBuilder Marine-Degradable Products - bioplastics MAGAZINE](https://www.bioplasticsmagazine.com/en/news/meldungen/20231213-PHAbuilder.php)
- [PhaBuilder Collaborations - PR Newswire](https://www.prnewswire.com/news-releases/phabuilder-collaborates-with-solenis-and-hengxin-302199209.html)
- [Engineering bacteria for enhanced PHA biosynthesis - PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC5655382/)
