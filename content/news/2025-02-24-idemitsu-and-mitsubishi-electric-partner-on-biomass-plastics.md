...
The core of this partnership relies on the "mass balance" method, a crucial mechanism in the transition to sustainable materials. Idemitsu Kosan will manufacture biomass plastics by mixing bio-based raw materials—derived from renewable sources such as waste cooking oil or tall oil—with conventional petroleum-based feedstocks during the cracking process.
