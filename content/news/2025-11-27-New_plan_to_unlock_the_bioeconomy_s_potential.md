...
sitemap:
  priority: 0.7
summary: The European Commission has adopted a new Bioeconomy Strategy, explicitly
  integrating bio-based plastics into a coherent regulatory framework and preparing
  for legally binding targets, signaling a major shift in EU industrial policy.
tags:
- bio-based
- bioplastics
