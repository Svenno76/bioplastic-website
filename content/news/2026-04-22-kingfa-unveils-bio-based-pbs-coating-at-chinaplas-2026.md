...
| Property | Kingfa PBS Coating | Conventional PE Coating |
|----------|-------------------|------------------------|
| Bio-based content | High (bio-based succinic acid) | 0% |
| Home compostable | Yes | No |
| Industrial compostable | Yes (EN 13432) | No |
| Coating weight | Reduced | Baseline |
| Processing speed | High-speed compatible | Baseline |
| Temperature resistance | High and low | High only |
| Oil resistance | Excellent | Good |
| Surface tension adaptability | Excellent | Standard |
