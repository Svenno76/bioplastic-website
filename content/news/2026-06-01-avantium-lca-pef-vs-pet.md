---
title: "Avantium Publishes Updated LCA: releaf® PEF Cuts GHG Emissions up to 88% vs. PET in 500 mL Bottles"
...
company: ["Avantium"]
source: "Avantium"
source_url: "https://newsroom.avantium.com/avantium-publishes-updated-life-cycle-assessment-confirming-up-to-88-lower-carbon-emissions-for-releaf/"
featured_image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1024&q=80"
sitemap:
  priority: 0.7
---

**AMSTERDAM, Netherlands** — **Avantium N.V.** has published an **updated Life Cycle Assessment (LCA)** for its **releaf® PEF (polyethylene furanoate)** polymer, confirming up to **88% lower greenhouse gas emissions** compared to conventional PET in **500 mL beverage bottle applications** under representative European conditions.
...
| Impact Category | releaf® PEF | PET (Virgin) | Reduction |
|-----------------|-------------|--------------|-----------|
| **Climate Change (GWP 100a)** | **0.12 kg CO₂ eq** | 1.02 kg CO₂ eq | **88%** |
| **Fossil Resource Scarcity** | 0.03 kg oil eq | 0.38 kg oil eq | 92% |
| **Water Consumption** | 0.8 L | 2.1 L | 62% |
| **Land Use** | 1.2 m²a crop eq | 0.3 m²a crop eq | +300%* |
...
- [Avantium Press Release: Updated LCA for releaf®](https://newsroom.avantium.com/avantium-publishes-updated-life-cycle-assessment-confirming-up-to-88-lower-carbon-emissions-for-releaf/)
- [Avantium LCA Page](https://avantium.com/products-technologies/lca/)
- [RecyClass PEF/PET Compatibility Evaluation](https://recyclass.eu/)
- [PolyesterTime coverage](https://www.polyestertime.com/avantium-releaf-pef-bedding-upholstery/)
- [ChemXplore: Avantium LCA 2026](https://chemxplore.com/substances/pet)
- [Avantium FY 2025 Results Presentation (PDF)](https://avantium.com/wp-content/uploads/2026/03/Avantium-FY-2025-Results-Investor-Presentation.pdf)
