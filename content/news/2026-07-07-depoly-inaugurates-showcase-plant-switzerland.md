---
title: "DePoly Inaugurates Showcase Plant in Switzerland for PET Chemical Recycling"
date: 2026-07-07T10:00:00+02:00
draft: false
summary: "Swiss circular materials company DePoly opens first industrial-scale depolymerization facility in Monthey, processing 500 tonnes/year as blueprint for 50,000 tonne commercial plant."
tags: ["Chemical Recycling", "PET", "Depolymerization", "Circular Economy", "Switzerland"]
...
**MONTHEY, Switzerland** — **DePoly**, a circular materials company based in Sion, Switzerland, inaugurated its **Showcase Plant** in Monthey on **July 6–7, 2026**. The first depolymerization facility of its kind and scale in Switzerland, this industrial Showcase Plant represents a major milestone in the company's growth and its journey toward commercialization.

At a time when more than **450 million tonnes of plastic waste** are generated every year worldwide, of which less than 10% is effectively reused, DePoly views plastic waste as a valuable material resource. Reintegrating it into production chains not only reduces the reliance on fossil resources but also strengthens the resilience and sovereignty of supply chains.

## Light-Activated Depolymerization: Lab to Industrial Scale
...
**From laboratory to industrial scale** — Founded in 2020 as an EPFL spin-off by Samantha Anderson, Chris Ireland, and Bardiya Valizadeh, DePoly was born from the ambition to make plastics truly circular. Based in Sion with a team of around 30 employees, the company is taking a decisive step with the opening of its Showcase Plant in Monthey.
...
The result of a significant investment with the creation of **12 direct jobs and more than 30 indirect jobs**, the Showcase Plant has a nominal capacity of around **500 tonnes feedstock input per year**. Beyond production, it will serve to optimize the process, qualify raw materials with industrial customers, and prepare for the deployment of DePoly's first commercial plant, which targets a capacity of **50,000 tonnes per year**.
...
## Versatile Process for Difficult Waste Streams
...
Its strength lies in its **versatility**. It handles a wide range of waste streams that are poorly served by conventional recycling today: food packaging, polyester textiles, complex films, coloured or contaminated materials. The recovered raw materials find applications across sectors as varied as packaging, textiles, automotive and electronics.

## Industrial Milestone for Switzerland and the Circular Economy
...
The lessons learned and process built at the Monthey site will feed directly into the development of DePoly's **first commercial plant** — a pioneering facility unprecedented at this scale, already in preparation, with its location to be announced in the first half of 2027. Targeting a capacity of **50,000 tonnes per year**, this plant will represent a decisive step toward the large-scale deployment of DePoly's technology. Beyond this next milestone, DePoly has already established itself for international growth with commercial projects and strategic partnerships in key markets around the world. The long-term goal: to make material circularity an industrial reality on a global scale.

## Resources

- [DePoly Website](https://depoly.ch/)
- [DePoly News: Showcase Plant Inauguration](https://depoly.ch/en/news/depoly-inaugurates-its-showcase-plant-in-switzerland)
- [EPFL](https://www.epfl.ch/)

## Company Boilerplate

**DePoly** is a circular materials company based in Sion, Switzerland, developing light-activated chemical depolymerization technology to recycle PET into virgin-quality monomers. Founded in 2020 as an EPFL spin-off, the company is backed by leading industrial and financial investors including BASF, Beiersdorf, and Infinity. DePoly's technology processes PET in under 60 minutes without high temperature or pressure, handling coloured, contaminated, and complex waste streams.

---

Source: DePoly press release, July 7, 2026