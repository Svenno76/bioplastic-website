...
Located adjacent to the company’s existing manufacturing hub in Beli Manastir, Croatia, the new logistics centre aims to consolidate warehousing and distribution operations. This €2 million infrastructure upgrade will allow EcoCortec to streamline its European supply chain, drastically reducing lead times for its industrial customer base. By centralizing storage and shipping operations, the company also anticipates a measurable reduction in the transport-related carbon footprint of its bio-based materials, further supporting its environmental objectives.

## Meeting Demand for Compostable VCI Films

The infrastructure expansion comes in direct response to surging industrial demand for sustainable packaging alternatives. EcoCortec is widely recognized for integrating its proprietary VCI technology into certified compostable biopolymer matrices. Products such as their Eco-Corr Film® leverage complex blends of biodegradable polyesters—specifically PBAT (polybutylene adipate terephthalate) and PLA (polylactic acid)—to provide effective, multi-metal corrosion protection. This allows industries to replace conventional, highly persistent polyethylene films with compostable bioplastics. The new logistics capacity will ensure steady, high-volume availability of these specialized films for the automotive, electronics, and heavy machinery sectors.
