...
Avantium's PEF, branded as **releaf®**, is a high-performance polyester made from plant-based sugars via the company's proprietary **YXY® Technology**. The key building block, FDCA (furandicarboxylic acid), is catalytically converted from fructose, creating a polymer that is **100% bio-based** (derived from renewable plant sugars), **fully recyclable** (compatible with existing PET recycling streams), offers **superior barrier performance** (10× better oxygen barrier and 2× better CO₂ barrier than PET), and boasts **enhanced mechanical strength** allowing for lightweighting.
...
This collaboration spans the complete production chain, involving **Avantium** as the PEF (releaf®) polymer supplier from Amsterdam, Netherlands, **Gepack** handling bottle manufacturing (injection stretch blow molding) in Portugal, and **Frubaça** managing beverage filling and formulation, also in Portugal.
...
> **Lígia Passos**, Head of R&D at Gepack:
> *\"This project demonstrates how new materials can be integrated into existing bottle production processes. Working with Avantium and partners enables us to evaluate PEF in a real application and across the value chain.\"*

> **Bineke Posthumus**, Commercial Director at Avantium:
> *\"Collaborating across the value chain is essential to assess how new materials perform in real applications. This project allows us to evaluate PEF across the full process, in a compact and distinctive shot format — a category that combines strong consumer appeal with a real need for high-performance, more sustainable packaging.\"*

## Technical Advantages for Functional Beverages

The functional beverage shot format presents unique challenges that PEF effectively addresses. Its superior oxygen barrier protects volatile actives and prevents oxidation of sensitive ingredients, contributing to **flavor and nutrient protection** and **shelf-life extension** without relying on excessive preservatives. The material's higher mechanical strength also enables **material reduction** through thinner walls, while its **circular compatibility** allows PEF bottles to be recycled in existing PET streams (validated by RecyClass). Furthermore, its bio-based feedstock contributes to a **lower carbon footprint** by reducing lifecycle greenhouse gas emissions.

## Market Context

The global functional beverage market is projected to reach **$250+ billion by 2028**, with the \"shot\" format growing at double-digit rates. Brands are under pressure from the EU Single-Use Plastics Directive (SUPD) and Packaging and Packaging Waste Regulation (PPWR) to increase recycled content and improve recyclability—while consumers demand cleaner labels and sustainable packaging.
...
Recent milestones include the **June 2026 RecyClass validation** of PET/PEF bottles as fully recyclable in the PET stream, a **June 2026 partnership with Amcor Rigid Packaging** on plant-based PEF packaging, and an **ongoing Hoogesteger capacity reservation agreement** for releaf® supply.

## Resources

- [Avantium Press Release](https://newsroom.avantium.com/avantium-collaborates-with-gepack-and-frubaca-on-small-pef-bottles-for-functional-beverage-shots/)
- [releaf® Product Information](https://releaf.bio/)
- [Avantium YXY® Technology Overview](https://avantium.com/products-technologies/yxy-technology/)
